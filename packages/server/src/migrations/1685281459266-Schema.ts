...
export class Schema1685281459266 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`media\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` text NULL, \`isPublic\` tinyint NOT NULL DEFAULT 1, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleteAt\` datetime(6) NULL, \`downloadId\` varchar(36) NULL, \`posterId\` varchar(36) NULL, \`metadataId\` varchar(36) NULL, \`fileId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`download_item\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL, \`url\` varchar(255) NOT NULL, \`status\` enum ('DOWNLOADED', 'DOWNLOADING', 'FAILED') NOT NULL, \`error\` text NULL, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`sourceId\` int NULL, \`ruleId\` int NULL, \`logId\` varchar(36) NULL, UNIQUE INDEX \`IDX_900be723d0d64b162ce682cc9d\` (\`title\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`episode\` (\`id\` int NOT NULL AUTO_INCREMENT, \`no\` varchar(255) NULL, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleteAt\` datetime(6) NULL, \`seriesId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`series\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` text NULL, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleteAt\` datetime(6) NULL, \`userId\` int NULL, \`posterId\` varchar(36) NULL, \`posterLandscapeId\` varchar(36) NULL, UNIQUE INDEX \`IDX_68b808a9039892c61219f868f2\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`media_subtitle_files\` (\`mediaId\` varchar(36) NOT NULL, \`fileId\` varchar(36) NOT NULL, INDEX \`IDX_ef3e5b54af6a84c1ddafe76cf5\` (\`mediaId\`), INDEX \`IDX_5299e7c642578c62ffd2e9799d\` (\`fileId\`), PRIMARY KEY (\`mediaId\`, \`fileId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`media\` ADD CONSTRAINT \`FK_b187fea587b79fe6518a789b62f\` FOREIGN KEY (\`metadataId\`) REFERENCES \`file\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`media_subtitle_files\` ADD CONSTRAINT \`FK_ef3e5b54af6a84c1ddafe76cf58\` FOREIGN KEY (\`mediaId\`) REFERENCES \`media\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`media_subtitle_files\` ADD CONSTRAINT \`FK_5299e7c642578c62ffd2e9799d2\` FOREIGN KEY (\`fileId\`) REFERENCES \`file\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`media_subtitle_files\` DROP FOREIGN KEY \`FK_5299e7c642578c62ffd2e9799d2\``);
        await queryRunner.query(`ALTER TABLE \`media_subtitle_files\` DROP FOREIGN KEY \`FK_ef3e5b54af6a84c1ddafe76cf58\``);
        ...
        await queryRunner.query(`ALTER TABLE \`media\` DROP FOREIGN KEY \`FK_b187fea587b79fe6518a789b62f\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_5299e7c642578c62ffd2e9799d\` ON \`media_subtitle_files\``);
        await queryRunner.query(`DROP INDEX \`IDX_ef3e5b54af6a84c1ddafe76cf5\` ON \`media_subtitle_files\``);
        await queryRunner.query(`DROP TABLE \`media_subtitle_files\``);
