...
export class Schema1685281459266 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`rule\` ADD CONSTRAINT \`FK_0fba34c0f0e23f53e5058650a35\` FOREIGN KEY (\`sourceId\`) REFERENCES \`source\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`rule\` ADD CONSTRAINT \`FK_01d624a99fe247221b050083b73\` FOREIGN KEY (\`seriesId\`) REFERENCES \`series\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`fetch_log\` ADD CONSTRAINT \`FK_4f282fdbf618217bd3f224854b0\` FOREIGN KEY (\`sourceId\`) REFERENCES \`source\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
